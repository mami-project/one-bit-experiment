...
start_iperf_servers tg_mobile ${TG_IPERF_PORT_2} ${TG_IPERF_PORT_3}
...
readonly TCP_LOGFILE_3="iperf-tcp-la-stats.json"
start_tg_tcp_clients \
  ${TG_IPERF_PORT_3} \
  5 \
  ${TEST_FUN_LA_MARK} \
  ${DURATION} \
  "${C_RESDIR}/${TCP_LOGFILE_3}"
...
plot_iperf_output "${TCP_LOGFILE_3}" "${H_RESDIR}" tcp
